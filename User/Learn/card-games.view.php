...
<body>
    ...
    <div class="content">
        ...
        <main>
            <button class="game-category" onclick=window.location.href="macao.view.php">Macao</button>
            <button class="game-category" onclick=window.location.href="whist.view.php">Whist</button>
        </main>
    </div>
